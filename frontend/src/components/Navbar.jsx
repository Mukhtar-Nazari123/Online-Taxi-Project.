  ...
  render() {
    return (
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="#1"><h1>Online Taxi</h1></a>
          ...
          <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            <div class="offcanvas-header">
              <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">Online Taxi</h5>
        ...
        <div className='sign_buttons d-flex flex-row'>
          <Link to="/login" className="text-decoration-none">
            <input className='sign bg-primary text-white' type="button" value="sign in" />
          </Link>
          <Link to="/register" className="text-decoration-none">
            <input className='sign bg-primary text-white' type="button" value="sign up" />
          </Link>
          </div>
      </nav>
    );
