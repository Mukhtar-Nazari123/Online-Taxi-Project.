    ...
    <form class="" role="search">
        <div className='col bg-white rounded my-3 d-flex flex-row align-items-center justify-content-between'>
            <div className='searchBar col-xl-4 d-flex justify-content-center m-3'>
                ...
                <input class="searchInput form-control" type="search" placeholder="Search" aria-label="Search"/>
                <button class="searchButton btn btn-outline-success bg-primary" type="submit">Search</button>
                </div>
            </div>
            <div className='m-3'>
